...
- Conteúdo pensado para ser **didático, acessível e envolvente**
- Proposta de **democratização do acesso à educação**
...
Este foi o **maior projeto que desenvolvi**, tanto durante o curso quanto fora dele, consolidando meus conhecimentos em desenvolvimento mobile, banco de dados em nuvem e arquitetura de aplicações.
